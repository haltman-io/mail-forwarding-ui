...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "ui-smooth relative flex cursor-default items-center gap-2 rounded-md py-1.5 pr-2 pl-8 text-sm text-[var(--text-secondary)] outline-hidden select-none focus:bg-[color:var(--hover-state)] focus:text-[var(--text-primary)] data-[highlighted]:bg-[color:var(--hover-state)] data-[highlighted]:text-[var(--text-primary)] data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
